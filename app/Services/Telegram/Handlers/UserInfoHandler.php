...
class UserInfoHandler
{
    ...
    {
        $message =
          "✅ مرحباً <b>{$user->first_name}</b>!\n\n" .
          "يسعدنا انضمامك إلى البوت ✨\n\n" .
          "⚙️ قبل البدء في استخدام المزايا، يجب عليك الدخول إلى قسم الإعدادات لضبط البوت أولاً.\n" .
          "📌 إكمال الإعدادات ضروري لبدء الاستخدام بالشكل الصحيح.\n\n" .
          "بعد ضبط الإعدادات، يمكنك الاستفادة من جميع وظائف البوت بكل سهولة! 🎉";
          
        $keyboard = [
            'inline_keyboard' => [
                [
                    ['text' => '🔎 مصدر جلب مستخدمين', 'callback_data' => 'get_users'],
                    ['text' => '🛠️ اعدادات', 'callback_data' => 'settings'],
                ],
                [
                    ['text' => '🔄 ارسال المستخدمين', 'callback_data' => 'send_users'],
                ],
            ],
        ];
